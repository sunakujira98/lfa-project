            ...
            <div className='w-2/3'>
              <div className='border-t-[1px] border-l-[1px] rounded-tl-[40px] rounded p-8 h-full'>
                <p>
                  ...
                  ultrices dignissim blandit dignissim dolor. Nisl laoreet in
                  eget morbi commodo purus urna risus felis. Vulputate at
                  blandit consectetur dictum gravida vel non euismod. Morbi a
                  convallis massa viverra semper orci blandit vel. Nulla tellus
                  sit tortor neque sollicitudin luctus. A mauris enim elit
                  lectus sit. Mauris lobortis amet enim molestie amet dis.
                  Mattis mauris id etiam habitant sapien ac neque quam.
                  Pellentesque suscipit volutpat elit etiam sagittis nunc
                  sapien.
                </p>
              </div>
            </div>
